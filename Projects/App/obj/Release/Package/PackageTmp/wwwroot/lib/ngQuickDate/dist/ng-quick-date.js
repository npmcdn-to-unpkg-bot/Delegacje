  ...
  app.provider("ngQuickDateDefaults", function() {
    return {
      options: {
        ...
        defaultTime: null,
        dayAbbreviations: ["N", "Pn", "Wt", "Ś", "Czw", "Pt", "So"],
        dateFilter: null,
