    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ExpenseDocumentTypes", t => t.DocumentTypeId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Subsistences", t => t.SubsistenceId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.SubsistenceMeals", new[] { "MealTypeId" });
