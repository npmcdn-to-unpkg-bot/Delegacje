...
Currency AFA = new Currency() { Code = "AFA", Name = "afgani" };	Country Afganistan = new Country() { Name = "Afganistan", SubsistenceAllowance = 47, AccomodationLimit = 140, Currency = AFA, LimitCurrency = EUR };	context.Countries.AddOrUpdate(vt => vt.Name, Afganistan);
...
Currency AON = new Currency() { Code = "AON", Name = "kwanza" };	Country Angola = new Country() { Name = "Angola", SubsistenceAllowance = 61, AccomodationLimit = 180, Currency = AON, LimitCurrency = USD };	context.Countries.AddOrUpdate(vt => vt.Name, Angola);
...
Currency AZM = new Currency() { Code = "AZM", Name = "manat" };	Country Azerbejdżan = new Country() { Name = "Azerbejdżan", SubsistenceAllowance = 43, AccomodationLimit = 150, Currency = AZM, LimitCurrency = EUR };	context.Countries.AddOrUpdate(vt => vt.Name, Azerbejdżan);
...
Currency EEK = new Currency() { Code = "EEK", Name = "korona estońska" };	Country Estonia = new Country() { Name = "Estonia", SubsistenceAllowance = 41, AccomodationLimit = 100, Currency = EEK, LimitCurrency = EUR };	context.Countries.AddOrUpdate(vt => vt.Name, Estonia);
...
Currency MDL = new Currency() { Code = "MDL", Name = "lej" };	Country Mołdowa = new Country() { Name = "Mołdowa", SubsistenceAllowance = 41, AccomodationLimit = 85, Currency = MDL, LimitCurrency = EUR };	context.Countries.AddOrUpdate(vt => vt.Name, Mołdowa);
...
Currency MNT = new Currency() { Code = "MNT", Name = "tugrik" };	Country Mongolia = new Country() { Name = "Mongolia", SubsistenceAllowance = 45, AccomodationLimit = 140, Currency = MNT, LimitCurrency = EUR };	context.Countries.AddOrUpdate(vt => vt.Name, Mongolia);
	Country Niderlandy = new Country() { Name = "Niderlandy", SubsistenceAllowance = 50, AccomodationLimit = 130, Currency = EUR, LimitCurrency = EUR };	context.Countries.AddOrUpdate(vt => vt.Name, Niderlandy);
...
Currency PLN = new Currency() { Code = "PLN", Name = "złoty" };	Country Polska = new Country() { Name = "Polska", SubsistenceAllowance = 0, AccomodationLimit = 0, Currency = PLN, LimitCurrency = PLN };	context.Countries.AddOrUpdate(vt => vt.Name, Polska);
...
Currency VEB = new Currency() { Code = "VEB", Name = "boliwar" };	Country Wenezuela = new Country() { Name = "Wenezuela", SubsistenceAllowance = 60, AccomodationLimit = 220, Currency = VEB, LimitCurrency = USD };	context.Countries.AddOrUpdate(vt => vt.Name, Wenezuela);
